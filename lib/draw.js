...
function loadAllImages() {
    boxPic = loadImage('assets/korob_3.png');
    wallPic = loadImage('assets/stena_true.png');
    floorPic = loadImage('assets/pol2.png');
    playerPic1 = loadImage('assets/gg.png');
    playerPic2 = loadImage('assets/gg1.png');
    buttonPic = loadImage('assets/place_200x200.png');
    placedBoxPic = loadImage('assets/fridge_green.png');
}
...
function drawWin() {
    ...
    text('Победа!', 62, 132);
    textSize(30);
    text('Нажмите Enter для продолжения', 55, 190);
    counter++;
}
