...
function displayHtmlValues() {
    document.getElementById("sizeTxt").innerHTML = "Размер комнаты: " + String(document.getElementById("sizeSlider").value);
    document.getElementById("boxTxt").innerHTML = "Количество коробок: " + String(document.getElementById("numSlider").value);
}
